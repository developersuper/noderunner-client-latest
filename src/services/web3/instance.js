import {
  ...
  DEV_GET_STAKED_NFT_ADDRESS,
  DEV_GET_STAKED_NFT_ADDRESS_1,
  PROD_GET_STAKED_NFT_ADDRESS,
  PROD_GET_STAKED_NFT_ADDRESS_1,
  DEV_GET_STAKED_NFT_ABI,
  PROD_GET_STAKED_NFT_ABI
...
export const getStakedNFTInstance = (web3) => {
  let abi;
  let instance;
  let address;

  if (REACT_APP_BUILD_MODE === "development") {
    abi = DEV_GET_STAKED_NFT_ABI;
    address = DEV_GET_STAKED_NFT_ADDRESS;
  } else if (REACT_APP_BUILD_MODE === "production") {
    abi = PROD_GET_STAKED_NFT_ABI;
    address = PROD_GET_STAKED_NFT_ADDRESS;
  }
...
//for round1
export const getStakedNFTInstance_1 = (web3) => {
  let abi;
  let instance;
  let address;
  ...
  if (REACT_APP_BUILD_MODE === "development") {
    abi = DEV_GET_STAKED_NFT_ABI;
    address = DEV_GET_STAKED_NFT_ADDRESS_1;
  } else if (REACT_APP_BUILD_MODE === "production") {
    abi = PROD_GET_STAKED_NFT_ABI;
    address = PROD_GET_STAKED_NFT_ADDRESS_1;
  }
...
export const getFinishedWarsInstance = (web3, index = 1) => {
  const warsData =
    REACT_APP_BUILD_MODE === "production"
...
//for round 1
export const getFinishedWarsInstance_1 = (web3, index = 0) => {
  const warsData =
    REACT_APP_BUILD_MODE === "production"
      ? finishedHashWars[index].prod
      : finishedHashWars[index].dev;
